...
print("Nazywam się Piotr Toma. Mój login GitHub to PiotrToma. Temat mojej pracy magisterskiej: Wizualizacja i analiza danych przestrzennych bazy danych GNSS i parametrów meteorologicznych przy pomocy języka GMT")
print("Powyższy skrypt na podstawie zadanej nazwy użytkownika wyszukuje użytkownika (użytkowników) o najbardziej zbliżonym guście muzycznym. Rekomenduje ocenionych przez najbliższego sąsiada wykonawców, których jeszcze nie ocenił dany użytkownik. ")
